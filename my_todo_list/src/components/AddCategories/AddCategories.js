...
const displayAddCategoriesForm = "d-flex";
...
class AddCategories extends Component {
  ...
  onSubmit() {
    ...
    setCat(categories); // - передаётся массив из объектов [{},{},{} ...]
  ...
  render() {
    ...
    return (
      ...
      >
        <div className="AddCategoriesContant d-flex flex-column p-5 rounded-lg">
          <AddCategoriesHeader name="Добро пожаловать" margin="mb-5" />
          <AddCategoriesInput
            checked={false}
            onAdd={this.addCat}
